...
3. **The seller disclosure forms contain no mention** of sidewalk, foundation, or structural issues (PDFs embedded below).
...
5. **Neighbors independently confirmed knowledge:** the sidewalk caved in, and next-door neighbors recounted the prior owners saying they "knew they needed to get to working on the deck."
...
7. **Erosion is a documented, neighborhood-wide problem:** the HOA's Wolf River Bank Erosion Project — addressing riverbank failures and sink holes, "years in the making" per the HOA President in recent emails — extends up to this property's backyard, and residents at the time (including the prior owners) paid the HOA toward it (confirmed in conversations with neighbors, including a former HOA board member).
...
### Seller Disclosures
   ...
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/disclosures/River Landing - PCD.pdf" target="_blank">📄 Open PDF: River Landing - PCD.pdf</a></p>
      <iframe src="./pdfs/disclosures/River Landing - PCD.pdf" width="100%" height="600px" frameborder="0"></iframe>

      <p><a href="./pdfs/disclosures/River Landing - disclosure .pdf" target="_blank">📄 Open PDF: River Landing - disclosure .pdf</a></p>
...
- The prior owners hired Olshan Foundation Repair: quote given **11/19/2021**, work performed **12/2021**. Olshan's documentation of that work, provided to me by Tim Hughes on 12/5/2025:
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/foundation/olshan/past/946 River Landing Drive , 20251205_Customer Proposal.pdf" target="_blank">📄 Open PDF: 946 River Landing Drive , 20251205_Customer Proposal.pdf</a></p>
...
- **11/20/2025 & 12/8/2025** — I emailed the HOA asking whether there was any record of the concrete repair where the sidewalk had caved in. The HOA had **no records** of the work:
   ...
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/HOA.pdf" target="_blank">📄 Open PDF: HOA.pdf</a></p>
...
<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
   <figure style="width: 50%; text-align: center;">
      <img src="./images/sidewalkFix2.jpg" style="width: 100%; height: auto;"/>
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/sidewalkFix1.jpg" style="width: 100%; height: auto;"/>
      <figcaption>
...
1. Had the sidewalk cave in with a sinkhole (repaired via Olshan 12/2021, never disclosed, no HOA record of the work).
2. Had to pay the HOA — along with other residents at the time — toward this major Wolf River erosion project that runs up to their backyard. This has been confirmed in many conversations with neighbors, including one with a previous HOA board member, emails as of recent confirming the start of the project.
...
HOA emails (all from Harbor Town Community Association to Alex and Erika):
...
1.  **8/24/2025** — Noticed the main overhang from support post to support joist was sagging, and the deck overhang had damage that needed fixing
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
       <figure style="width: 100%; text-align: center;">
          <img src="./images/overhang.jpg" style="width: 50%; height: 50%;"/>
          <figcaption>
       ...
       <figure style="width: 100%; text-align: center;">
          <img src="./images/sagging.jpg" style="width: 50%; height: 50%;"/>
          <figcaption>
       ...
       <figure style="width: 100%; text-align: center;">
          <img src="./images/rotting.jpg" style="width: 50%; height: 50%;"/>
          <figcaption>
...
<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
   <figure style="width: 50%; text-align: center;">
      <img src="./images/floatingBeam.jpg" style="width: 100%; height: auto;"/>
      <figcaption>
...
<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/rottedLanding.jpg" style="width: 100%; height: auto;" />
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/polyDrillHole.jpg" style="width: 100%; height: auto;" />
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/acUnitHole.jpg" style="width: 100%; height: auto;" />
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/exposedRebar.jpg" style="width: 100%; height: auto;" />
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/sandbagToStopErosion.jpg" style="width: 100%; height: auto;" />
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/foundationComparison.jpg" style="width: 100%; height: auto;" />
      <figcaption>
   ...
   <figure style="width: 50%; text-align: center;">
      <img src="./images/freshFoundationCover.jpg" style="width: 100%; height: auto;" />
      <figcaption>
...
1.  The courtyard downspout — connected to the flower bed that sits against the void under the AC unit — was installed incorrectly: water from roughly 1/3 of the house gushed out of it, soaking the flower bed, stripping paint off the siding in that section, and adding to the erosion in the hole. Matt also found that the gutter guards installed by the previous owners let water topple over rather than drain during heavy rain.
    - **11/6/2025** — Matt fixed both issues, replacing all gutter guards and properly connecting the downspout/gutter so water could not escape — $600 in labor alone
      <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
         <figure style="width: 50%; text-align: center;">
            <img src="./images/badDownSpout.jpg" style="width: 100%; height: auto;"/>
            <figcaption>
...
1.  **10/23/2025 — DFX**
    ...
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/foundation/dfx/Alex Cash_Updated DFX Agreement.pdf" target="_blank">📄 Open PDF: Alex Cash_Updated DFX Agreement.pdf</a></p>
...
1.  **10/30/2025 — Redeemers Group**
    ...
    - Gave 3 repair options; overall recommended installing piers at a corner for better support
      <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
            <p><a href="./pdfs/foundation/redemers/Cash Redeemers Group, Inc. Proposal (Project 1, 10_30_25 1_09 pm).pdf" target="_blank">📄 Open PDF: Cash Redeemers Group, Inc. Proposal (Project 1, 10_30_25 1_09 pm).pdf</a></p>
            ...
            <p><a href="./pdfs/foundation/redemers/Cash Redeemers Group, Inc. Proposal (Project 2, 10_30_25 1_09 pm).pdf" target="_blank">📄 Open PDF: Cash Redeemers Group, Inc. Proposal (Project 2, 10_30_25 1_09 pm).pdf</a></p>
            ...
            <p><a href="./pdfs/foundation/redemers/Cash Redeemers Group, Inc. Proposal (Project 3, 10_30_25 1_09 pm).pdf" target="_blank">📄 Open PDF: Cash Redeemers Group, Inc. Proposal (Project 3, 10_30_25 1_09 pm).pdf</a></p>
...
1.  **11/3/2025 — Olshan Foundation Repair**
    - Olshan had the best plan for structural support across the whole house, using external and internal pilings so each piling's area of influence fixed the current issues without leaving gaps for future problems. Olshan's recommended plan — 20 external and 14 internal pilings — was **$43,235.00** (not including the cost to repair interior drill holes, refinishing the floor, or re-installing the neighbor's turf carpet to drill since some of the planned work is on their property). I worked with them on a modified plan covering all high- and medium-priority areas — 13 external and 6 internal pilings — for **$24,375.00** (same exclusions).
      <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
         <p><a href="./pdfs/foundation/olshan/Alex Cash, 946 River Landing Drive, 20251103_Customer Proposal.pdf" target="_blank">📄 Open PDF: Alex Cash, 946 River Landing Drive, 20251103_Customer Proposal.pdf</a></p>
    ...
    - **Technician Tim Hughes told me at the start of the visit that he had been to this house before** — he gave the quote and did the 2021 sidewalk work for the previous owners, and pulled up the exact photos from that job on his iPad. He said he had wanted to inspect inside the house at the time, but the owner did not want him to and made him stay outside to work on the sidewalk only.
    - While inspecting inside the house for cracks and door/window issues, Tim noted **clear signs of cracks being covered with fresh paint, nail pops in the walls, and what looks like new trim work** (the past owners replaced all windows, re-finished the floors, and repainted, right before selling the house)
    ...
    - **12/5/2025** — Tim Hughes (thughes@olshanfoundation.com) sent an "Exterior only" proposal, scoped to exterior perimeter work only
      <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
         <p><a href="./pdfs/foundation/olshan/Alex Cash, 946 River Landing Drive, 20251205_Customer Proposal.pdf" target="_blank">📄 Open PDF: Alex Cash, 946 River Landing Drive, 20251205_Customer Proposal.pdf</a></p>
...
1. **12/9/2025** — Olshan installed external pilings (exterior perimeter scope of the modified repair plan, completed 12/8–10/2025) to stabilize ONLY.
...
1. **2/11/2026** — Received Olshan warranty documents from Gia Fox (Admin, Olshan Foundation Repair and Waterproofing)
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/foundation/olshan/warranty/946 river landing dr.pdf" target="_blank">📄 Open PDF: 946 river landing dr.pdf</a></p>
...
1. **4/21/2026** — Tim Hughes (Certified Structural Technician / Polyurethane Specialist) sent an updated estimate
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/foundation/olshan/Alex Cash, 946 River Landing Drive, 20260421_Customer Proposal.pdf" target="_blank">📄 Open PDF: Alex Cash, 946 River Landing Drive, 20260421_Customer Proposal.pdf</a></p>
...
1. **6/19/2026** — Ozer delivered the initial foundation report
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/ozer/946 River Landing DR report (initial).pdf" target="_blank">📄 Open PDF: 946 River Landing DR report (initial).pdf</a></p>
...
1. **6/30/2026** — Ozer delivered the updated foundation report. They explained the elevation measurement discrepancy: Ozer set one location as **0.0 inches** as their benchmark and measured all other elevations relative to that point; Olshan used a different reference point, which is why the numerical values differ even though the overall floor profile and settlement areas are similar
   <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
      <p><a href="./pdfs/ozer/946 River Landing DR report (updated).pdf" target="_blank">📄 Open PDF: 946 River Landing DR report (updated).pdf</a></p>
      <iframe src="./pdfs/ozer/946 River Landing DR report (updated).pdf" width="100%" height="600px" frameborder="0"></iframe>
   </div>

### Ozer's recommended repair plan — flaw identified by Olshan

Ozer's recommended approach to fix the settlement involved pumping poly fill under the house to push it back up to level.

- **7/6/2026 (Monday)** — I called Tim Hughes (Olshan) to review Ozer's recommendation. He explained why the poly-fill approach is a bad plan for this house: if a pipe breaks under the slab while the house is being pushed back up to level — a real risk during lifting — the cured layer of poly fill makes that failure far harder to repair. The poly layer is effectively additional concrete that would have to be drilled through just to reach the broken pipe. In other words, the recommended fix would compound any plumbing failure it causes, instead of addressing the underlying support problem the way pilings do.
...
<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
   <p><a href="./pdfs/arborsHarbor/Office Copy NTV Wilt, Cash.pdf" target="_blank">📄 Open PDF: Office Copy NTV Wilt, Cash.pdf</a></p>
...
<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
   <p><a href="./pdfs/arborsHarbor/Verification of Notice to Vacate Wilt, Cash.pdf" target="_blank">📄 Open PDF: Verification of Notice to Vacate Wilt, Cash.pdf</a></p>
...
| Deck/balcony structural remediation                                                                                                                              | 2025–2026            | invoices to be compiled |
...
- Germantown Hardwood Floors
   <p><a href="./pdfs/flooring/germantownhardwoodfloorsinc.pdf" target="_blank">📄 Open PDF: germantownhardwoodfloorsinc.pdf</a></p>
...
- **11/25/2025** — Mid South Flooring
    <p><a href="./pdfs/flooring/Mid_South_Flooring_LLC.pdf" target="_blank">📄 Open PDF: Mid_South_Flooring_LLC.pdf</a></p>
...
- Erick's Flooring
    <p><a href="./pdfs/flooring/Ericks Flooring estimate 467.pdf" target="_blank">📄 Open PDF: Ericks Flooring estimate 467.pdf</a></p>
